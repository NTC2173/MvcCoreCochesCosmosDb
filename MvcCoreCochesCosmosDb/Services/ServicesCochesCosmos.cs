...
namespace MvcCoreCochesCosmosDb.Services
{
    public class ServiceCochesCosmos
    {
        ...
        {
            //LOS ELEMENTOS QUE RECORREN CON UN Iterator QUE ES UN ELEMENTO QUE 
            //NO SABE CUANTOS REGISTROS EXISTEN, SIMPLEMENTE VA HACIA DELANTA HASTA
        ...
        {
            ItemResponse<Vehiculo> response = await this.containerCosmos.ReadItemAsync<Vehiculo>
                (id, new PartitionKey(id));
